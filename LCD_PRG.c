...
/* Function used to send a drawing as an array of characters
* Options:
* arr: array of characters each range[0-255] (each byte represents one byte of the drawing)
*/
void LCD_VidDrawCharToCGRAM(u8 arr[])
{
